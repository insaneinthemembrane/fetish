...
const string strMessageMagic = "fetish Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "fetish", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "fetish starts again";
        CTransaction txNew;
        if (!fTestNet)
        {
            txNew.nTime = 1497831055;
        }
        else
        {
            txNew.nTime    = 1497831054; // Without separate txNew.nTime near block.nTime, CheckBlock fails on coinbase timestamp for TestNet created on 1497831057.
        }
        txNew.vin.resize(1); 
        txNew.vout.resize(1);
        ...
        // debug print
        assert(block.hashMerkleRoot == uint256("0xb38f7a338dfd71a2e8087e4d1740c07a7d0fa1251d2dc915780e159ca5576d84"));
        block.print();
...
unsigned char pchMessageStart[4] = { 0xdb, 0xd0, 0xc2, 0xa1 };
